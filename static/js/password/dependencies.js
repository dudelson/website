...
window.ArrayBuffer || document.write("<script src=../static/js/password/typedarray-polyfill.js><\/script>");

// If TextEncoder is not supported we include the polyfill
// https://github.com/inexorabletash/text-encoding
window.TextEncoder || document.write("<script src=../static/js/password/encoding-polyfill.js><\/script>");
	
// If Promise is not supported we include the polyfill
// https://github.com/taylorhakes/promise-polyfill
window.Promise || document.write("<script src=../static/js/password/promise-polyfill.js><\/script>");

// If setImmediate is not implemented we include the polyfill
window.setImmediate || document.write("<script src=../static/js/password/setImmediate-polyfill.js><\/script>");
...
ES6 || document.write("<script src=../static/js/password/mpw-js/traceur-runtime.js><\/script>");

// Include the scrypt implementation
var SCRYPTASM_PATH = (window.location + '').replace(/[^/]*(#[^#]*)?$/, '../static/js/password/mpw-js/scrypt-asm.js');
document.write("<script src=../static/js/password/mpw-js/" + esdir + "scrypt.js?1><\/script>");

// Include the MPW class
document.write("<script src=../static/js/password/mpw-js/" + esdir + "mpw.js?1><\/script>");
